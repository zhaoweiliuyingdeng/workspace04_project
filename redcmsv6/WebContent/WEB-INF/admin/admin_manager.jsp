<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="java.util.*,com.redcms.*" %>
  ...
  <td>
    ...
    <input type="hidden" name="id" value="<%=a.getId()%>"/>
     ...
     <input type="text" name="newpwd" class="form-control" placeholder="输入新密码"/>
      ...
      <td>
         <select class="form-control" name="upur">
			      <!--  <option value="100000" <%=a.getUpwd().startsWith("100")?"selected=\"selected\"":"" %>>管理员</option>
			      <option value="010000" <%=a.getUname().startsWith("010")?"selected=\"selected\"":"" %>>普通管理员</option>
			      <option value="0010000" <%=a.getUpwd().startsWith("001")?"selected=\"selected\"":"" %>>一般</option>-->
         </select>
